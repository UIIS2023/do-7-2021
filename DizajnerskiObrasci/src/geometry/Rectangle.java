...
public class Rectangle extends Shape implements Serializable {
	...
	public Rectangle(Point upperLeftPoint, int width, int height,Color edge,Color file) {
		this.upperLeftPoint = upperLeftPoint;
		this.width=width;
		this.height=height;
		this.fillColor=file;
	...
	public String toString() {
		return "Rectangle: x=" + upperLeftPoint.getX() + "; y=" + upperLeftPoint.getY() + "; height=" + height + "; width=" + width + "; edge color=" + getEdgeColor().toString().substring(14).replace('=', '-') + "; area color=" + getFillColor().toString().substring(14).replace('=', '-');
	}
